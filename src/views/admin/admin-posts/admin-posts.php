...
<h5 class="admin-dashboard__section-title full-width">Posts</h5>
...
<tr>
    ...
    <td>
        <a href="/admin/posts/{{ user.id }}/update" class="admin-dashboard__list-link margin-divider-small">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="admin-dashboard_table-icon">
    ...
    <td>
        <a href="/admin/posts/{{ user.id }}/delete" class="admin-dashboard__list-link margin-divider-small">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="admin-dashboard_table-icon">
